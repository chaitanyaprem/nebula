...
var (
	...
	WakuStatusClusterConfig = WakuClusterConfig{WakuClusterID: 16, WakuShards: []uint32{32, 64, 128}}
	WakuTWNClusterConfig    = WakuClusterConfig{WakuClusterID: 1, WakuShards: []uint32{0, 1, 2, 3, 4, 5, 6, 7}}
)
